...
uint8_t Direction, LumiereI, LumiereE, Demarre,LumiereP, Clee, Verouille;
...
void main(void)
{
    ...
    RXB0CON = 0X60;
    mode_transmission.frame.dlc = 0x01;
    mode_transmission.frame.id = 0x21;

    vehicule_demarre.frame.dlc = 0x01;
    vehicule_demarre.frame.id = 0x11;

    vitesse.frame.dlc = 0x01;
    vitesse.frame.id = 0x54;

    temperature.frame.dlc = 0x04;
    temperature.frame.id = 0x44;
    while (1)
    {
