...
void traitement(void) {
    ...
    if (vehicule_demarre.frame.data0 == 0x01) {
        ...
        if (mode_transmission.frame.data0 == 0x00) {
            vitesse = (int8_t) ((float) pourcentage_commande.frame.data0 * 25 / 100);
...
void main(void) {
    ...
    ECAN_SetRXB0InterruptHandler(ecan_rx_isr);
    ...
    vitesse_vehicule.frame.dlc = 0x01;
    ...
    message_reference.frame.id = 0x00;
