...
# 123 "./mcc_generated_files/ccp5.h"
void CCP5_Initialize(void);
# 139 "./mcc_generated_files/ccp5.h"
void CCP5_CaptureISR(void);
# 180 "./mcc_generated_files/ccp5.h"
...
uint8_t etatLumiereInt;
uint8_t etatLumiereExt;
...
void main(void) {
    ...
    TMR1_SetInterruptHandler(detectionClignotant);
...
# 66 "main.c"
        if (compteur >= 10)
        {
            ...
            transmissionLumiereInt();
            transmissionLumiereExt();
            gestionClignotantD();
            gestionClignotantG();
        }
...
void transmissionLumiereInt(void) {
    ...
    msg.frame.id = 0x53;
    msg.frame.dlc = 1;
    msg.frame.data0 = etatLumiereInt;
...
void transmissionLumiereExt(void) {
    ...
    msg.frame.id = 0x54;
    msg.frame.dlc = 1;
    msg.frame.data0 = etatLumiereExt;
    while(CAN_transmit(&msg) == 0);
...
void gestionClignotantD(void) {
    ...
    msg.frame.id = 0x52;
    msg.frame.dlc = 1;
    msg.frame.data0 = flagClignotantD;
    while(CAN_transmit(&msg) == 0);
}

void gestionClignotantG(void) {

    if (flagClignotantG == 1)
    {
        printf("\n\r btn G high");
        printf("\n\r");
    }
    msg.frame.id = 0x51;
    msg.frame.dlc = 1;
    msg.frame.data0 = flagClignotantG;
    while(CAN_transmit(&msg) == 0);
...
void detectionClignotant(void)
{
    flagClignotantG = PORTBbits.RB5;
    flagClignotantD = PORTBbits.RB7;
    compteur++;
}
