...
//**********************************************
//FONCTION A RAJOUTER DANS LE CODE POUR LE TTCAN 
//**********************************************

void receptionTTCAN(void) {  //fonction pour le temps de parole du TTCAN
...
void compteurTT(void) {  //Compteur pour le compter les temps de parole
    compteurTTCAN++;     //du TTCAN.
}
