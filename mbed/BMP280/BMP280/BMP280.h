...
public:
     ...
     *
     */
    void initialize(uint8_t t_sb=0b000, uint8_t osrs_p=0b011, uint8_t filter=0b011);
  ...
  //  float getHumidity(void);
     ...
     *
     */
    uint32_t getRawPressure(void) {return press_raw;};
    
    uint16_t    getP1(void) {return dig_P1;};
    int16_t     getP2(void) {return dig_P2;};
    int16_t     getP3(void) {return dig_P3;};
    int16_t     getP4(void) {return dig_P4;};
    int16_t     getP5(void) {return dig_P5;};
    int16_t     getP6(void) {return dig_P6;};
    int16_t     getP7(void) {return dig_P7;};
    int16_t     getP8(void) {return dig_P8;};
    int16_t     getP9(void) {return dig_P9;};
